            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Tabla de usuarios inactivos</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                            <li class="breadcrumb-item active">Tabla de usuarios inactivos</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Usuarios del sistema<code>.inactivos</code></h6>
                ...
                echo "error de consulta";
                  ...
                  for($i =0; $i<=$fila; $i++){
                     ...
                     echo "<tr>";  
                          ...
                          echo "<td> <a href='tablain.php?no=".$fila[0]."''><button type='button' class='btn waves-effect waves-light btn-info hidden-md-down text-white'>Activar</button></a> </td>";
                     echo "</tr>";   
