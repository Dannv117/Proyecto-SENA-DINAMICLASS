                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Configurar notificación</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            ...
                            <div class="contenedor">
                                <center>
                                <a href="https://www.google.com.br/?#q=como+desactivar+bloqueo+ventana+emergente+navegadores" target:"_blank" class="obs">(*) - Hay que desactivar bloqueo de ventanas emergentes (pop-ups) antes de programar la notificación</a>
  <div class="t">Hora:</div>
  <div class="timeis" id="tm"></div>
</div>

<div class="desperta">
  Indique la hora especifica para accionar la notificación:<br/><br/> hora: <input type="text" id="hora"> minuto: <input type="text" id="minuto"></center>
