            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block">
                                    <div>
                                        <h5 class="card-title mb-0">Interacción de los estudiantes</h5>
                                    </div>
                                    <div class="ms-auto">
                                        <ul class="list-inline text-center font-12">
                                            <li><i class="fa fa-circle text-success"></i>SOPA DE LETRAS</li>
                                            <li><i class="fa fa-circle text-info"></i>PREGUNTAS</li>
                                            <li><i class="fa fa-circle text-primary"></i>AHORCADOS</li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <br><hr>
                            <div class="message-center" style="height: 420px !important;">
                                ...
                                <a href="#">
                                    ...
                                    <div class="mail-contnet">
                                        <h6 class="text-dark font-medium mb-0">Configura tu pausa</h6> <span class="mail-desc">No se te olvide 
                                            programar tu alarma</span> <span class="time"></span>
                                    </div>
                                </a>
                                <!-- Message -->
                    ...
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="up-img" style="background-image:url(../assets/images/instructor.jpeg)"></div>
                            <div class="card-body">
