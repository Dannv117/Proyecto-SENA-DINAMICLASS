...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <main class="container-fluid">
        ...
        <div class="row" id="app">
         ...
         <br><br><br>  <br><br><br>
                <h3 class="displayed-word">Palabra: <br>{{displayWord()}}</h3>
                <p class="h4 text-danger">Número de intentos: {{remainingAttempts}}</p>
                <br>
        ...
        <div class="container-login100-form-btn">
                        <a href='words.php'><button  class='btn waves-effect waves-light btn-info hidden-md-down text-white' >
                            Regresar
                        </button>
                    </div>
    </main>
