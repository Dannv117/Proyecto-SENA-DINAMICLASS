...
<head>
    ...
    <title>Creación Actividad</title>
    ...
    <!-- Custom CSS -->
    <link href="css/styleacti.css" rel="stylesheet">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="mi_perfil.php" id="navbarDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php   echo $imagen; ?>" class="img-circle" width="25" />
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="miperfil.php" aria-expanded="false"><i
                         ...
                         <li> <a class="waves-effect waves-dark" href="veracti.php" aria-expanded="false"><i
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Mis actividades</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="instru.php">Home</a></li>
                            <li class="breadcrumb-item active"><a href="veracti.php">Mis Actividades</a></li>
                        </ol>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="contenedor">
                                        ...
                                        <div class="cajadecajas" ><!--Caja contenedor-->
                                            <div class="imagen-port"><!--Contenedor de imagenes-->
                                                <img src="../assets/images/sopa.gif" alt="">
                                                <p class="pactividades">Sopa de letras</p>
                                                <a href="sopa.php?id=1"><div class="hover-galeria">
                                                    <img src="../model/icono1.png" alt="">
                                                    <p>Sopa de letras</p>

                                                </div></a>
                                                </div>
                                            <div class="imagen-port">
                                                <img src="../assets/images/crucigrama.gif" alt="">
                                                <p class="pactividades">Crucigramas</p>
                                            <a href="activinstruc.html"> <div class="hover-galeria">
                                                <img src="../model/icono1.png" alt="">
                                                    <p>Crucigrama</p>
                                                </div> </a>
                                            ...
                                            <div class="imagen-port">
                                                <img src="../assets/images/pregunta.gif" alt="">
                                                <p class="pactividades">Preguntas y respuestas</p>
                                                <a href="crear_preguntas.php"> <div class="hover-galeria">
                                                    <img src="../model/icono1.png" alt="" >
