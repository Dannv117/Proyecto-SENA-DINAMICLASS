        ...
        <div class="row" id="app">
            ...
            <div class="col-12 text-center">
                <div class="form-inline mb-2">
                    ...
                    <label class="mr-2" for="newWord">Añadir palabra:</label>
                    <input @keyup="deleteWhiteSpaces()" placeholder="Escriba su palabra aquí" class="m-2 form-control"
            ...
            <div class="col-12 text-center">
                <div class="jumbotron jumbotron-fluid" v-show="!words.length">
                    <div class="container">
                        ...
                        <p class="lead">Por favor, añada palabras para iniciar</p>
                    </div>
                </div>
